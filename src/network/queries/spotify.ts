        ...
        queries: [
            {
                queryKey: ['artists'],
                queryFn: () =>
                    SpotifyService.fetchTopItems<TopArtistsResponse>({ type: 'artists' }),
...
export function useTopItemsInfiniteQuery<T extends TopArtistsResponse | TopTracksResponse>(
    ...
    return useInfiniteQuery({
        ...
        initialPageParam: 0,
        queryFn: ({ pageParam }) =>
            SpotifyService.fetchTopItems<T>({ ...params, limit: 10, offset: pageParam }),
